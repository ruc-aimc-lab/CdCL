...
def main(train_collection, val_collection, config_path, test_collection, run_num):
    ...
    pred_path = os.path.join(collection_root + '_out', test_collection, 'Predictions', train_collection,
                            val_collection, config_name, 'runs_{}'.format(run_num), 'results.csv')
    gt_path = os.path.join(collection_root, test_collection, 'Annotations', 'anno.txt')
    ...
    with open(os.path.join(collection_root + '_out', test_collection, 'Predictions', train_collection,
                            val_collection, config_name, 'runs_{}'.format(run_num), 'eval_results.csv'), 'w') as fout:
